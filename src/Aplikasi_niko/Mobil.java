...
DefaultTableModel t= new DefaultTableModel();
 ...
 JOptionPane.showMessageDialog(rootPane, e); 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
         try { 
res=stat.executeQuery("select * from mobil where "+ "kode_barang='" +kode_mobil.getText()
+"'" );
while (res.next()) 
{
    kode_mobil.setText(res.getString("kode_barang")); 
    nama_mobil.setText(res.getString("nama_barang"));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            stat.executeUpdate("update mobil set "
                + "kode_barang='"+kode_mobil.getText()+"',"
                + "nama_barang='"+nama_mobil.getText()+"',"
                + "merk='"+merk.getText()+"',"
                + "warna='"+warna.getText()+"',"
                + "ukuran='"+tahun.getText()+"',"
                + "harga='"+harga.getText()+"'"

                + " where " + "kode_barang='"+kode_mobil.getText()+"'" );
            kosongkan();
